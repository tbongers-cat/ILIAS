 ...
 * ---
 * description: >
 *   Example for rendring a laugh glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome laughing-smiley symbol on a grey background. Moving the cursor above the symbol will darken it's
