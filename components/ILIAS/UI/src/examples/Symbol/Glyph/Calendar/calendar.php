 ...
 * ---
 * description: >
 *   Example for rendring a calendar glyph.
 *
 * expected output: >
 *   Active:
 *   ILIAS shows a monochrome calendar symbol on a grey background. Moving the cursor above the symbol will darken it's
